...
def test_graph_export_offline_hashes_and_query_files_are_byte_reproducible(
    ...
    state_input = fixture_document["courtStates"][0]
    offline_state = create_court_state(
        court_position_id=state_input["courtPositionId"],
        harmonic_profile_sha256=state_input["harmonicProfileSha256"],
        court_policy_sha256=state_input["courtPolicySha256"],
    )
    assert court_node["properties"]["courtStateSha256"] == offline_state.court_state_sha256
