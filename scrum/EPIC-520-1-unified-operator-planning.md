...
**GOV-520 run outcome — H2 record (2026-09-07).** Rule-8 sync from provenance/DECISION_LEDGER.md, "GOV-520 production run record — underdetermined; GOV-520 closed — 2026-09-07": the H2 ring-force enumeration was executed once against the amended GOV-518 boundary at B₃ (C_adj ∧ C_close; C_step2 removed by "GOV-518 degeneracy ruling and boundary amendment — 2026-09-07" after the original registration was found degenerate-by-construction). Recorded category: **underdetermined** — 2859 admissible outcome classes; the observed singleton-peak shape family is present in 1911 classes and absent from 948 (53 distinct statistics); the §2 weakening condition ("more than one admissible class remains") is realized. Disposition: weakens H2-as-amended(B₃); H3 compatible-with-but-not-confirming; H1: no disposition. The original three-predicate constraint set remains unmeasured against a discriminating statistic; any successor is bound by the two-level non-vacuity acceptance obligation and answers its own boundary only. Full run record, artifacts, and hashes: see the cited ledger entry; production receipt `qa/gov-520-production-receipt.json`.
