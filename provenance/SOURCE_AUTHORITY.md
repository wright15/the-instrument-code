...
| `provenance/neo4j-full-database-baseline.json` | Current release projection baseline | Pins the exact seven normalized namespace fingerprints and source bindings accepted by release 1.8.1; its isolated clean-import and separately configured bootstrap/roundtrip receipts remain distinct evidence records |
